...
<p align="center">
  🌐 <b><a href="https://iamahmedfarid.com/">Ahmed Farid — full portfolio, case studies &amp; ways to work together →</a></b>
</p>
...
<p align="center"> <a href="https://iamahmedfarid.com/" target="_blank"><img alt="Portfolio" src="https://img.shields.io/badge/Portfolio-Visit-00FFAA?style=for-the-badge&logo=googlechrome&logoColor=white&labelColor=0D1117" /></a> <a href="mailto:ahmed@iamahmedfarid.com" target="_blank"><img alt="Email — ahmed@iamahmedfarid.com" src="https://img.shields.io/badge/Email-ahmed%40iamahmedfarid.com-E6C8A0?style=for-the-badge&logo=maildotru&logoColor=E6C8A0&labelColor=0B0D10" /></a> <a href="mailto:a.farid@recoveryadvisers.com" target="_blank"><img alt="Work Email" src="https://img.shields.io/badge/Work%20Email-0A66C2?style=for-the-badge&logo=maildotru&logoColor=white" /></a> <a href="https://www.linkedin.com/in/ahmed-farid-b46a5221b/" target="_blank"><img alt="LinkedIn" src="https://img.shields.io/badge/linkedin-0077b5.svg?style=for-the-badge&logo=linkedin&logoColor=white" /></a> <a href="https://www.linkedin.com/in/ahmed-farid-b46a5221b/overlay/1782022237581/single-media-viewer?profileId=ACoAADeBkOYB6O_rbWtqld6CsWkhtTkpduSbKXo" target="_blank"><img alt="View My CV" src="https://img.shields.io/badge/View%20My%20CV-Click%20Here-blue?style=for-the-badge" /></a> <a href="https://calendly.com/ahmedfareed2025/30min" target="_blank"><img alt="Book a Call" src="https://img.shields.io/badge/Book%20a%20Call-Calendly-006BFF?style=for-the-badge&logo=calendly&logoColor=white" /></a> <a href="https://wa.me/971585562001" target="_blank"><img alt="WhatsApp — UAE" src="https://img.shields.io/badge/WhatsApp-UAE-25D366?style=for-the-badge&logo=whatsapp&logoColor=white" /></a> <a href="https://wa.me/201013996079" target="_blank"><img alt="WhatsApp — Egypt" src="https://img.shields.io/badge/WhatsApp-Egypt-25D366?style=for-the-badge&logo=whatsapp&logoColor=white&labelColor=1a7f45" /></a> <a href="https://www.behance.net/ahmedfarid20" target="_blank"><img alt="Behance" src="https://img.shields.io/badge/Behance-0054F7?style=for-the-badge&logo=behance&logoColor=white" /></a> <p>
...
<!--
  This image is a STATIC SVG generated by the "GitHub Metrics" GitHub Action
  (.github/workflows/metrics.yml) and committed to this repo as github-metrics.svg.
  Because GitHub serves it directly, it can't show the broken "image not exist"
  icon the way live third-party stat cards do. The Action refreshes it twice a day.
-->
...
<!--
  Top languages — a STATIC SVG generated by the "Top Languages" GitHub Action
  (.github/workflows/languages.yml + .github/scripts/gen_languages.py). It scans
  all public repos with the built-in GITHUB_TOKEN and commits languages.svg here,
  so GitHub serves it directly and it can't show the broken "image not exist"
  icon. Refreshes twice a day.
-->

<p align="center">
  <img src="https://raw.githubusercontent.com/ahmedfarid2/ahmedfarid2/main/languages.svg" alt="Most used languages" />
</p>
...
A <b>patient platform for J&amp;D Pharmacy, a trusted neighborhood pharmacy on Yellowstone Blvd in Forest Hills, NY</b> — a Flutter app (iOS &amp; Android), a React web frontend and a Django REST backend. J&amp;D is a full-service community pharmacy (drive-through pickup, vaccinations, home medical equipment, an Rx Easy Ready-Fill auto-refill service and even a Military Discount Program), and the platform puts that in patients' pockets: register and sign in via OTP, request refills (guest checkout, no account needed), transfer prescriptions in from another pharmacy, book appointments, and track each request in real time — refills processed asynchronously on the backend via a Celery task queue. Standout features include timezone-aware medication reminders, a full medication history, and a HIPAA-compliance &amp; pharmacy-info hub.

<b>🛠 Stack:</b> Flutter · Dart · BLoC/Cubit (flutter_bloc) · flutter_modular (DI &amp; routing) · Dio · Hive · flutter_secure_storage · Clean Architecture (mobile) · Django · Django REST Framework · Celery · React · PostgreSQL (backend &amp; web)<br/>
...
<b>✨ Highlights:</b> OTP-based registration &amp; password reset with JWT refresh · Prescription refill requests with guest checkout &amp; async status tracking · Async refill processing via Celery task queue (backend) · Prescription transfer between pharmacies · Appointment booking &amp; medication history · Scheduled, timezone-aware medication reminders · Health-news feed with paginated HTML articles · Pharmacy location, contact &amp; HIPAA-compliance screens<br/>
...
A <b>patient platform for Medical Center Compounding Pharmacy &amp; Health Center in Cleveland, TN</b> — a Flutter app (iOS &amp; Android), a React web frontend and a Django REST backend. As a compounding pharmacy and health center it goes well beyond standard dispensing, and the app lets patients request prescription refills for pickup or delivery, transfer prescriptions in from another pharmacy, schedule multi-dose medication reminders, and book appointments — every request automatically faxed and emailed to the pharmacy and tracked to completion in the background. Built on the multi-tenant RevealSite codebase, it loads each pharmacy by client ID with its own branding, hours and drive-thru details at runtime.
...
A <b>patient platform for QuickRx, a family-owned accredited specialty pharmacy across New York &amp; New England that ships to all 50 states</b> — a Flutter app (iOS &amp; Android), a React web frontend and a Django REST backend. With a care team that monitors refills around the clock, the app lets patients refill prescriptions in a few taps, transfer their profile and prescriptions to QuickRx, book appointments with specialists, and set medication reminders — every request automatically faxed and emailed to the pharmacy and tracked to completion in the background, on the multi-tenant RevealSite codebase.
...
A <b>patient platform for Holland Discount Pharmacy, an independent pharmacy on S. McCord Rd in Holland, OH</b> — a Flutter app on iOS &amp; Android plus a React web frontend, backed by a Django REST API. Holland is a full-service neighborhood pharmacy (durable medical equipment, immunizations, compounding, a drive-up window and its own in-house medication delivery), and the platform brings that to patients' phones: request prescription refills for pickup or delivery, transfer prescriptions in from another pharmacy, set multi-dose medication reminders, and book appointments — every request is automatically faxed and emailed to the pharmacy and tracked to completion in the background.
