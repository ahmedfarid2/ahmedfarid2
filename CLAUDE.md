...
GitHub profile README repository (README, CV PDF, contribution-snake workflow, languages-SVG script). No build. Validate with `python3 -m py_compile .github/scripts/gen_languages.py` and by checking README links.
